...
public interface FriendsDAO
{
	...
	boolean withdrawrequest(int loggedInUserId, int otherUserId);

	boolean remove(int loggedInUserId, int otherUserId);

	boolean block(int loggedInUserId, int otherUserId);

	boolean acceptrequest(int loggedInUserId, int otherUserId);

	boolean rejectingafriend(int loggedInUserId, int otherUserId);
