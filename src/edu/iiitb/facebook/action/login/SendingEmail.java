...
public boolean	sendmail(String email,String password,int otp) throws AddressException, MessagingException
{
	
	
	String host = "smtp.gmail.com";
	String port = "587";
	final String adminUser = "pradarttana@gmail.com";
	final String adminPassword = "Lotus@1989";
