...
public class WithdrawFriendRequest extends ActionSupport implements SessionAware {
	...
	public String execute() {
		System.out.println("u are trying to withdraw");
	    User user = (User) session.get("user");
	    if (null != user) {
	    	userId = user.getUserId();
	    	status = friendsDAO.withdrawrequest(userId, friendId);
	    	System.out.println("u have succeded in withdraw");
	    	return SUCCESS;		
	    } else {
	    	return LOGIN;
	    }
