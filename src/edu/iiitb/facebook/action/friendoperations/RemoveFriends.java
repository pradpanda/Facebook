...
public class RemoveFriends extends ActionSupport implements SessionAware {
	...
	public String execute() {
		System.out.println("u are trying to remove");
	    User user = (User) session.get("user");
	    if (null != user) {
	    	userId = user.getUserId();
	    	status = friendsDAO.remove(userId, friendId);
	    	System.out.println("u have succeded in remove");
	    	return SUCCESS;		
	    } else {
	    	return LOGIN;
	    }
