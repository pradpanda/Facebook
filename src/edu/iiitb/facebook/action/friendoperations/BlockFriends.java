...
public class BlockFriends extends ActionSupport implements SessionAware {
	...
	public String execute() {
		System.out.println("u are trying to block");
	    User user = (User) session.get("user");
	    if (null != user) {
	    	userId = user.getUserId();
	    	status = friendsDAO.block(userId, friendId);
	    	System.out.println("u have succeded in block");
	    	return SUCCESS;		
	    } else {
	    	return LOGIN;
	    }
