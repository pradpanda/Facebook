...
public class AcceptingFriend  extends ActionSupport implements SessionAware {
	...
	public String execute() {
		System.out.println("u are trying to accept");
	    User user = (User) session.get("user");
	    if (null != user) {
	    	userId = user.getUserId();
	    	status = friendsDAO.acceptrequest(userId, friendId);
	    	System.out.println("u have succeded in accept");
	    	return SUCCESS;		
	    } else {
	    	return LOGIN;
	    }
